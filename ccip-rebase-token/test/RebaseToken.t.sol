...
contract RebaseTokenTest is Test {
    ...
    error RebaseTokenTest__FailedToAddRewardsToVault();
    ...
    function addRewardsToVault(uint256 rewardAmount) public {
        ...
        if (!success) {
            revert RebaseTokenTest__FailedToAddRewardsToVault();
        }
    ...
    function testRedeemAfterTimePassed(uint256 depositAmount, uint256 time) public {
        ...
        console.log("balance after time warp", balanceAfterSomeTime);
