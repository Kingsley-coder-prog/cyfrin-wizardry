...
contract Vault {
    ...
    // create a deposit function that mints token to the user equal to the amount of ETH they deposited
    // create a redeem function that burns token s from the user and sends the user ETH
